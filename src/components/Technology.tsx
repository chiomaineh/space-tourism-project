...
function Technology() {
  ...
  return (
    <section className="relative min-h-screen text-white">
      ...
      {/* MAIN CONTENT */}
      <main className="flex flex-col items-center xl:flex-row xl:items-start justify-between gap-12 px-6 md:px-16 lg:px-32 py-10 lg:pt-40">
        <h2 className="text-left uppercase lg:text-left tracking-widest text-lg md:text-xl lg:text-2xl pt-6">
        ...
        <div className="flex justify-center xl:justify-end flex-1 order-2 xl:order-none w-full">
          ...
          <img
            src={tech.image2}
            alt={tech.name}
            className="hidden xl:block w-[28rem] h-auto object-cover ml-auto"
          />
        </div>
